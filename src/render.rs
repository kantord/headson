...
pub struct JsonObject<'a> { pub children: &'a [(usize, (String, String))], pub children_len: usize, pub omitted: usize, pub indent0: &'a str, pub indent1: &'a str }
...
pub struct PseudoObject<'a> { pub children: &'a [(usize, (String, String))], pub children_len: usize, pub omitted: usize, pub indent0: &'a str, pub indent1: &'a str }
...
pub struct JsObject<'a> { pub children: &'a [(usize, (String, String))], pub children_len: usize, pub omitted: usize, pub indent0: &'a str, pub indent1: &'a str }
...
pub struct ObjectCtx { pub children: Vec<(usize, (String, String))>, pub children_len: usize, pub omitted: usize, pub indent0: String, pub indent1: String }
...
pub fn render_object(template: OutputTemplate, ctx: &ObjectCtx) -> String {
    match template {
        OutputTemplate::Json => JsonObject { children: &ctx.children, children_len: ctx.children_len, omitted: ctx.omitted, indent0: &ctx.indent0, indent1: &ctx.indent1 }.render().unwrap(),
        OutputTemplate::Pseudo => PseudoObject { children: &ctx.children, children_len: ctx.children_len, omitted: ctx.omitted, indent0: &ctx.indent0, indent1: &ctx.indent1 }.render().unwrap(),
        OutputTemplate::Js => JsObject { children: &ctx.children, children_len: ctx.children_len, omitted: ctx.omitted, indent0: &ctx.indent0, indent1: &ctx.indent1 }.render().unwrap(),
    }
}
